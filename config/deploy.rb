...
set :application, "rails-101-groupme"
...
role :web, "rails-101-groupme.com"                          # Your HTTP server, Apache/etc
role :app, "rails-101-groupme.com"                         # This may be the same as your `Web` server
role :db,  "rails-101-groupme.com"   , :primary => true # This is where Rails migrations will run
